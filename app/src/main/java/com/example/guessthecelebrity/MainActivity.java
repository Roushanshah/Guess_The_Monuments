...
public class MainActivity extends AppCompatActivity {
    ...
    public void celebChosen(View view) throws ExecutionException, InterruptedException {
        if (view.getTag().toString().equals(Integer.toString(locationOfCorrectAnwer))) {
    ...
    public void createNewQuestion() throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            locationOfCorrectAnwer = random.nextInt(4);
            int incorrectAnswerLocation;
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnwer) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String[] splitResult = result.split("</strong> Old Goa Rd, Bainguinim, Goa</p>");
